...
// S2
:product_name: S2
:s2_platform: http://s2health.io
:s2_website_url: http://s2health.io
:s2_specs: https://specifications.s2health.io
:s2_specifications_forum: https://specifications.s2health.io
:s2_logo: http://s2health.io/logo.png

//
// ========= Jira =========
// links defined here are reprocessed in Nginx/Apache
//
:s2_jira_home: {s2_specs}/jira
:s2_prs: {s2_jira_home}/projects/SPECPR
:component_roadmap: {s2_specs}/components/{component}/roadmap
:component_history: {s2_specs}/components/{component}/history
:component_prs: {s2_specs}/components/{component}/open_issues
...
:openehr_logo: https://uploads-ssl.webflow.com/63570cd7d4eda80d654ccf14/64027a592d749e7df28c6248_primary-s2.svg
