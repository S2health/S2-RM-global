...
:graphite_platform: http://graphitehealth.io
:graphite_website_url: http://graphitehealth.io
:graphite_specs: https://specifications.graphitehealth.io
:graphite_specifications_forum: https://specifications.graphitehealth.io

//
// ========= Jira =========
// links defined here are reprocessed in Nginx/Apache
//
:graphite_jira_home: {graphite_specs}/jira
:graphite_prs: {graphite_jira_home}/projects/SPECPR
:component_roadmap: {graphite_specs}/components/{component}/roadmap
:component_history: {graphite_specs}/components/{component}/history
:component_prs: {graphite_specs}/components/{component}/open_issues
...
:openehr_logo: https://uploads-ssl.webflow.com/63570cd7d4eda80d654ccf14/64027a592d749e7df28c6248_primary-graphite.svg
