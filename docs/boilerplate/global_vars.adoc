...
:s2_platform: http://{s2_domain}
:s2_website_url: http://{s2_domain}
:s2_specs: https://specifications.{s2_domain}
:s2_specifications_forum: https://specifications.{s2_domain}
:s2_logo: https://studious-adventure-evrqgo5.pages.github.io/resources/logos/S2-logo.svg
