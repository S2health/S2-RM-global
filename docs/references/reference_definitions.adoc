...
:graphite_gcm_forum: http://GraphiteHealth.io

// --------------- BASE ----------------
:graphite_base_releases: {graphite_specs}/releases/BASE/{base_release}

:graphite_base_base_types: {graphite_base_releases}/base_types.html
:graphite_base_foundation_types: {graphite_base_releases}/foundation_types.html
:graphite_base_foundation_time_types: {graphite_base_foundation_types}#_time_types
:graphite_base_data_types: {graphite_base_releases}/data_types.html
:graphite_base_resource: {graphite_base_releases}/resource.html
:graphite_base_change_control: {graphite_base_releases}/change_control.html

:graphite_base_uml_diagrams: {graphite_base_releases}/UML/diagrams

// for link in preface part of docs
:graphite_base_latest: {graphite_specs}/releases/BASE/latest
:graphite_base_latest_base_types: {graphite_base_latest}/base_types.html
:graphite_base_latest_foundation_types: {graphite_base_latest}/foundation_types.html
:graphite_base_latest_data_types: {graphite_base_latest}/data_types.html
:graphite_base_latest_resource: {graphite_base_latest}/resource.html
:graphite_base_latest_change_control: {graphite_base_latest}/change_control.html


:graphite_overview: {graphite_base_releases}/architecture_overview.html

// --------------- GCM ----------------

:graphite_gcm_releases: {graphite_specs}/releases/GCM/{gcm_release}

:graphite_gcm_ehr: {graphite_gcm_releases}/ehr.html
:graphite_gcm_entry: {graphite_gcm_releases}/entry.html
:graphite_gcm_integration: {graphite_gcm_releases}/integration.html
:graphite_gcm_data_structures: {graphite_gcm_releases}/data_structures.html
:graphite_gcm_data_entity: {graphite_gcm_releases}/entity.html

// for link in preface part of docs
:graphite_gcm_latest: {graphite_specs}/releases/GCM/latest
:graphite_gcm_latest_ehr: {graphite_gcm_latest}/ehr.html
:graphite_gcm_latest_entry: {graphite_gcm_latest}/entry.html
:graphite_gcm_latest_integration: {graphite_gcm_latest}/integration.html
:graphite_gcm_latest_data_structures: {graphite_gcm_latest}/data_structures.html
:graphite_gcm_latest_data_entity: {graphite_gcm_latest}/entity.html
...
:openehr_am_adl14_pdf: {openehr_release_102_pdf}/am/adl.pdf
:openehr_am_aom14_pdf: {openehr_release_102_pdf}/am/aom.pdf
...
:snomed_comp_grammar: {snomed_doc_home}/DOCSCG/Compositional+Grammar+-+Specification+and+Guide
