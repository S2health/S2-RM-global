...
:s2_base_uml_diagrams: {s2_base_releases}/UML/diagrams
...
:s2_overview: {s2_base_releases}/architecture_overview.html

// --------------- RM ----------------

:s2_rm_releases: {s2_specs}/releases/RM/{rm_release}

:s2_rm_ehr: {s2_rm_releases}/ehr.html
:s2_rm_entry: {s2_rm_releases}/entry.html
:s2_rm_integration: {s2_rm_releases}/integration.html
:s2_rm_data_structures: {s2_rm_releases}/data_structures.html
:s2_rm_data_entity: {s2_rm_releases}/entity.html

// for link in preface part of docs
:s2_rm_latest: {s2_specs}/releases/RM/latest
:s2_rm_latest_ehr: {s2_rm_latest}/ehr.html
:s2_rm_latest_entry: {s2_rm_latest}/entry.html
:s2_rm_latest_integration: {s2_rm_latest}/integration.html
:s2_rm_latest_data_structures: {s2_rm_latest}/data_structures.html
:s2_rm_latest_data_entity: {s2_rm_latest}/entity.html
